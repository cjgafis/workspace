...
public class Batallon 
{
	...
	public Batallon() 
	{
		...
		s2 = new Soldado(234, "Carlos", "Ramirez", 20, 1.69, 7);
	...
	public soldadoMenosAntiguo ()
	
if (s1.getantiguedadAnos >= s2.getantiguedadAnos() && s3.getantiguedadAnos() >= s4.getantiguedadAnos()) {
	Object soldadoMenosAntiguo;
