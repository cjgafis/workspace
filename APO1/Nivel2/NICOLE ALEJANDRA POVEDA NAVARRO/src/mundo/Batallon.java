...
public class Batallon 
{
	...
	{
		String antiguo = null;
		if(anos<s1.getAntiguedadAnos())
		{
			antiguo= s1.getApellido();
			if(anos<s2.getAntiguedadAnos())
				{
					antiguo= antiguo+s2.getApellido();
					if(anos<s3.getAntiguedadAnos())
					{
						antiguo= antiguo+s3.getApellido();
						if(anos<s4.getAntiguedadAnos())
						{
							antiguo= antiguo+s4.getApellido();
						}
					}
				}
			}
