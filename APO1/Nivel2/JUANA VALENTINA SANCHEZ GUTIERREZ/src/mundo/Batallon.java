...
public class Batallon 
{
	...
	public Batallon() 
	{
		s1 = new Soldado(123, "Celso", "Rodriguez", 19, 1.65);
		s2 = new Soldado(234, "Carlos", "Ramirez", 20, 1.69);
		s3 = new Soldado(345, "Pablo", "Acero", 17, 1.73);
		s4 = new Soldado(456, "Pedro", "Perez", 23, 1.80);
	}
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("El soldado menos antiguo es:"Acero " + baser10.soldadoMenosAntiguo(  ));
		System.out.println("Los apellidos de los soldados mas antiguos son:"Perez","Ramirez" + baser10.masAntiguosQue( anos ));
