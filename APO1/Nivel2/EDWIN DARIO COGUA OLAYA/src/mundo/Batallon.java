...
public class Batallon 
{
	...
	// Escriba su codigo debajo de los to do. Nunca arriba. 
    public double soldadoMenosAntiguio() 
    {
    	double soldadoMenosAntiguo (s1.getAntiguedadAnos() + s2.getAntiguedadAnos() + s3.getAntiguedadAnos() + s4.getAntiguedadAnos()/4);
    	
    	
    	double soldadoMenosAntiguo =0;
		if (s1.getAntiguedadAnos()>= s2.getAntiguedadAnos() && s1.getAntiguedadAnos()> = s2.getAntiguedadAnos()  && s1.getAntiguedadAnos() > = s3.getAntiguedadAnos() && s1.getAntiguedadAnos() > = s4.getAntiguedadAnos());
    ...
    public double soldadoMasAntiguo (s1.getAntiguedadAnos)
