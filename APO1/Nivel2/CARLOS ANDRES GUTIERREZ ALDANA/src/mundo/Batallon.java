...
public class Batallon 
{
	...
	public Batallon() 
	{
		...
		s3 = new Soldado(345, "Pablo", "Acero", 17, 1.73, 2);
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("El soldado menos antiguo es: " + baser10.soldadoMenosAntiguo( anos ));
	...
	private String soldadoMenosAntiguo(int anos) {
		// TODO Auto-generated method stub
		return null;
	}
