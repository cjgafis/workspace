...
public class Batallon 
{
	...
	public Batallon() 
	{
		s1 = new Soldado(123, "Celso", "Rodriguez", 19, 1.65, 8);
		s2 = new Soldado(234, "Carlos", "Ramirez", 20, 1.69, 13);
		s3 = new Soldado(345, "Pablo", "Acero", 17, 1.73, 9);
		s4 = new Soldado(456, "Pedro", "Perez", 23, 1.80, 10);
	}
	...
	public int soldadoMenosAntiguo ()
	{
		soldadoMenosAntiguo = null;
		int antiguedadAnos = 0
