...
public class Batallon 
{
	...
	public Batallon getSoldadoMenosAntiguo( )
    {
        
		Batallon SoldadoMenosAntiguo = null;
    	...
    	else  (s2.getAntiguedadAnos() < s1.getAntiguedadAnos() && s2.getAntiguedadAnos() < s3.getAntiguedadAnos() && s2.getAntiguedadAnos() < s4.getAntiguedadAnos());
    	{
