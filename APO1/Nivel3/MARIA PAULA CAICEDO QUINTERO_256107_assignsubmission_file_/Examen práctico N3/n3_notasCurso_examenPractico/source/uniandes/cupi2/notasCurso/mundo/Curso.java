...
public class Curso
{
	...
	public int rangoConMasNotas ( ) 
	{
		...
		return respuesta; // el retorno es provisional.
	}
	...
	{
		return "El numero de rango en el que se encuentra el mayor numero de notas de todos los estudiantes del curso es : " + rangoConMasNotas();
	}
	...
	{
		double valor = 0.0;
		return "El numero de notas necesarias para llegar al numero ingresado es : " + sumadosDanElnumero(valor); 
		valor = Double.parseDouble(JOptionPane.ShowInputMessage("Ingrese un valor"));
	}
}