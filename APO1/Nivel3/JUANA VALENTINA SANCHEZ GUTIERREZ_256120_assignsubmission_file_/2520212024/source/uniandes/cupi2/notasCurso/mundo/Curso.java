...
public class Curso
{
	...
	public int rangoConMasNotas ( )
	{
		...
		if(rango1>rango2 && rango1>rango3) return 1;
		
		if(rango2>rango1 && rango2>rango3) return 2;
		
		if(rango3>rango1 && rango3>rango2) return 3;
	...
	{
		return "El rango con más notas es el rango #" + rangoConMasNotas();
	}
	...
	public String metodo2( )
	{
		...
		return "El número mínimo de notas que se deben sumar para alcanzar el valor dado por parámetro es: " + sumadasDanElNumero(valor); 
	}
}