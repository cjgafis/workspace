...
public class Curso
{
	...
	public int rangoConMasNotas ( ) 
	{
		...
		return rangoMasNotas; // el retorno es provisional.
	}
	...
	public int sumadasDanElNumero (double numero ) 
	{
		...
		return numeroDeNotas; // el retorno es provisional.
	}
	...
	{
		return "La respuesta del metodo 1 es: " + rangoConMasNotas();
	}
	...
	public String metodo2( )
	{
		...
		return "El numero de notas necesarias oara llegar al numero ingresado es: " + sumadasDanElNumero(valor);
	}
}