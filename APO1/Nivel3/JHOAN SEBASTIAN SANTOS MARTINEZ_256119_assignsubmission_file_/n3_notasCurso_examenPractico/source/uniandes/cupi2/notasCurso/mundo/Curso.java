...
public class Curso
{
	...
	public String metodo1( )
	{
		System.out.println("------- RANGOS ------- + "
				+ "/n1/ El rango 1 va de 0.0 a 1.99 +"
				+ "/n2/ el rango 2 va de 2.0 a 3.49 + "
				+ "/n3/ el rango 3 va de 3.5 5.0 +");
				
		return "el rango con mas notas es el: " + rangoConMasNotas ( );
	}
	...
	public String metodo2( )
	{
		...
		return " el numero de notas que son necesarias para llegar al numero ingresado es: " + sumadasDanElNumero(valor);
	}
}