...
public class Curso
{
	...
	public int rangoConMasNotas ( ) 
	{
		...
		for (int i =0; i< notas.length; i++)
		{
			...
			if (notas[i] >3.5 &&  notas[i]<=5.0);
			{
				rango3=i++;
			}		
			}
		
		return respuestas; // el retorno es provisional.
	}
...

	{
		...
		return "ingrese el numero de notas necesarias al numero de ingresados es";
	}
	...
	public String metodo2( )
	{
		...
		return "el numero de notas necesarias para llegar al numero ingresados es"; 
	}
}