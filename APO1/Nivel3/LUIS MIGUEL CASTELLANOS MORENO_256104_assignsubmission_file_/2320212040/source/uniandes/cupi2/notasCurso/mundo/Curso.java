...
public class Curso
{
	...
	public int rangoConMasNotas ( ) 
	{
		...
		for(int i = 0; i < notas.length; i++)
		{
			...
			{
				rangoConMasNota = rango1;
			}

			else 
				if(rango2 > rango1 && rango2 > rango3)
				{
					rangoConMasNota = rango2;
				}

				else 
					if (rango3 > rango1 && rango3 > rango2)
					{
						rangoConMasNota = rango3;
					}

		}

		return rangoConMasNota;
	}
	...
	public int sumadasDanElNumero (double numero ) 
	{
		...
		return suma; // el retorno es provisional.
	}
	...
	{
		String respuesta = " ";
		System.out.println("los rangos delimitados serian los siguientes: " + 
				" Rango1 = 0.0 a 2.0 " +
				" Rango2 = 2.0 a 3.5 " +
				" Rango3 = 3.5 a 5.0 ");
		System.out.println();
		System.out.println("El rango con mas notas es: " + rangoConMasNotas ( ));

		return "El rango con mas notas es: " + rangoConMasNotas ( ) ;
	}
	...
	{
		double valor = 0.0;
		valor = Double.parseDouble(JOptionPane.ShowInputMessage(" ingrese valor "));
		return "el numero de notas necesario para llegar al numero ingresado es: " + sumadasDanElNumero (numero); 
	}
}