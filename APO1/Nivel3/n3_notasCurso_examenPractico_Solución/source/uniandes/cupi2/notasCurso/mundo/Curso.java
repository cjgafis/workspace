...
public class Curso
{
	 ...
	 * pre: la lista debe estar creada. Lista != null.
	 * post: se calculo el rango que mayor numero de notas tiene. 
	 * @return el rango con mayor numero de notas. Retorna -1 en caso de no encontrar ninguno y que retorne el primer rango en caso de empate. 
	 */
	public int rangoConMasNotas ( ) 
	{
		...
		else if(rango2 >= rango1 && rango2 >= rango3)
		{
			respuesta = 2;
		}
		else if(rango3 >= rango1 && rango3 >= rango2)
		{
			respuesta = 3;
		}
	 ...
	 * pre: la lista debe estar creada. lista != null.
	 * post: se sumaron las notas con el fin de lograr alcanzar y superar el valor ingresado por parametro.
	 * @param numero, numero es el numero ingresado por el usuario. numero > 0.
	 * @return el numero de notas que se sumaron hasta alcanzar y superar el valor ingresado por parametro. 
	 * Se retorna -1 en caso de no alcanzar y superar a llegar al numero ingresado por parametro. 
	 */
	public int sumadasDanElNumero (double numero ) 
	{
		...
		for(int i = 0; i < notas.length && centinela == false; i++)
		{
			if(suma < numero)
			{
				suma = suma + notas[i];
	...
	{
		return "El rango con la nota mas repetida es:  "
				+ "\nRango 1 - de 0.0 a 1.99"
				+ "\nRango 2 - de 2.0 a 3.49"
				+ "\nRango 3 - de 3.5 a 5.0"
				+ "\nRespuesta: Rango " + rangoConMasNotas ( );
	}
	...
	{
		double numero = Double.parseDouble(  JOptionPane.showInputDialog("Ingrese el valor que desea alcanzar con la suma de las notas: ") );
		return "El numero de notas necesarias para llegar al numero " + numero + " es: " + sumadasDanElNumero (numero ) ; 
	}
}