...
public class Curso
{
	...
	public int rangoConMasNotas ( ) 
	{
		...
		if (rango_1 > rango_2 && rango_1 > rango_3)
		{
			rangoMasAlto = 1;
		}
		else if (rango_2 > rango_1 && rango_2 > rango_3)
		{
			rangoMasAlto = 2;
		}
		else if (rango_3 > rango_1 && rango_3 > rango_2)
		{
			rangoMasAlto = 3;
		}
		else if (rango_3 == rango_1 && rango_3 == rango_2)
		...
		return rangoMasAlto; // el retorno es provisional.
	}
	...
	public int sumadasDanElNumero (double numero ) 
	{
		...
		double suma = 0; 
		int contador = 0;
		int cantidadSumado = 0;
		for(int i = 0; i < notas.length; i++ ,encontrado = false)
		{
			suma = suma + notas[i];
			contador= contador + 1;
		...
		return cantidadSumado; // el retorno es provisional.
	}
