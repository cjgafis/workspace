...
public class InterfazNotasCurso extends JFrame
{
    ...
    public void cambiarNota( int estudiante )
    {
        ...
        {
            JOptionPane.showMessageDialog( this, "La nota debe tener un valor numerico. (ej. 2.5)", "Error", JOptionPane.ERROR_MESSAGE );
        }
    }
    
    public void refrescar()
    {
    	panelDatos.refrescarNotasALL(curso.getNotas());
    }
    ...
    {
        JOptionPane.showMessageDialog( this, "Numero de estudiantes con nota mayor al promedio: " + Integer.toString( curso.cuantosEncimaPromedio( ) ), "Estudiantes", JOptionPane.INFORMATION_MESSAGE );
    }
