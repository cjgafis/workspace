...
/**
 * Panel que administra la opcion 2
 */
public class PanelCalcular2 extends JPanel implements ActionListener
{
    // -----------------------------------------------------------------
    // Constantes
    // -----------------------------------------------------------------
    ...
    // -----------------------------------------------------------------
    /**
     * Crea el Panel donde se organizaran los objetos para las calculos de opcion 2
     * @param elPadre - instancia del panel contendor - elPadre!=null
     */
    public PanelCalcular2( InterfazClub elPadre )
    {
        padre = elPadre;
        setLayout( new GridLayout( 3, 3 ) );
        setBorder( BorderFactory.createTitledBorder( null, "Importar", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, null ) );

        // Bot�n calcular
        botonCalcular = new JButton( );
        inicializarBotones( botonCalcular, "Importar", OPCION_2, Color.black );
    ...
    public void actionPerformed( ActionEvent e )
    {
        ...
        if( OPCION_2.equals( actionCommand ) )
